...
//    TextView tvLevel;
    ...
    //每组设备个数、分组数
    private int groupSize = 3, groupNum, maxGroupSize;
    //是否正在训练标志
...
//                                    s = temp;
                            ...
                            //灭两个得两分，灭3个的三分，灭一个不得分
                            if(trainingInfo.deviceList.size()==2){
                                s=2;
                            }else if(trainingInfo.deviceList.size()==3){
                                s=3;
                            }
                            score += s;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_endurance1);
...
//        level=2;
    ...
    private void initView() {
        tvTitle.setText(R.string.technique_jump_item2);
    ...
    @OnClick({R.id.layout_cancel, R.id.btn_begin, R.id.img_help, R.id.img_save_new, R.id.btn_on, R.id.btn_off,R.id.btn_stop,R.id.img_set})
...
//                set_dialog.show();
            ...
            case R.id.img_help:
                ...
                Dialog dialog_help = DialogUtils.createHelpDialog(EnduranceActivity.this,list);
