...
public class TrainingListActivity extends Activity
{
    ...
    private Object[][] items = {
            ...
            {"计时","描述1",R.drawable.timekeeper,13,"4"},//计时
            {"次数随机","描述1",R.drawable.timekeeper,14,"4"},//次数随机
            {"时间随机","描述1",R.drawable.timekeeper,15,"4"},//时间随机
            {"分组对抗","描述1",R.drawable.timekeeper,16,"4"}//分组对抗
    };
