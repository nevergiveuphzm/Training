...
import com.oucb303.training.adpter.LateralJumpTimeListAdapter;
...
public class LateralJumpActivity extends AppCompatActivity {
    @Bind(R.id.tv_title)
    TextView tvTitle;
    ...
    private LateralJumpTimeListAdapter LateralJumpTimeListAdapter;
    //训练成绩
    private int[] scores;
    //key : 组号 value： 成绩
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lateral_jump);
        ...
        //重新检测设备数目
        battery = new Battery(device,imgStart,handler_battery);
    }
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case UPDATE_DATA:
                    sortTime(timeMap);
                    LateralJumpTimeListAdapter.setTimeMap(timeMap, keyId);
                    LateralJumpTimeListAdapter.notifyDataSetChanged();
                break;
    ...
    private void initView() {
        tvTitle.setText("横向跳跃练习");
        imgHelp.setVisibility(View.VISIBLE);
        imgSaveNew.setVisibility(View.VISIBLE);
        ///初始化分组listView
        groupListViewAdapter = new GroupListViewAdapter(LateralJumpActivity.this, groupSize);
        ...
        spGroupNum.setOnItemSelectedListener(new SpinnerItemSelectedListener(LateralJumpActivity.this, spGroupNum, groupNumChoose) {
            @Override
        ...
        //初始化右侧listview
        LateralJumpTimeListAdapter = new LateralJumpTimeListAdapter(this);
        lvTimes.setAdapter(LateralJumpTimeListAdapter);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_set:
                CustomDialog dialog = new  CustomDialog(LateralJumpActivity.this,"From btn 2",new CustomDialog.ICustomDialogEventListener() {
                    @Override
                ...
                operateUtils.setScreenWidth(LateralJumpActivity.this,dialog, 0.95, 0.7);
                break;
            ...
            case R.id.img_help:
                ...
                Dialog dialog_help = DialogUtils.createHelpDialog(LateralJumpActivity.this,list);
            ...
            case R.id.img_save_new:
                ...
                bundle.putString("trainingName", "横向跳跃运动");
...
//        imgSave.setEnabled(true);
        ...
        LateralJumpTimeListAdapter.setScores(scores);
        LateralJumpTimeListAdapter.setTimeMap(timeMap, keyId);
        LateralJumpTimeListAdapter.notifyDataSetChanged();
        //训练时间
