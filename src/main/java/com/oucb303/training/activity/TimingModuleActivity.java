...
//                            stopTraining();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_time_module_new);
...
//        tvMaxTime.setText("100");
    ...
    @OnClick({R.id.btn_stop, R.id.img_help,R.id.img_set,R.id.btn_off, R.id.btn_on, R.id.layout_cancel, R.id.btn_begin, R.id.img_save_new,R.id.btn_result, R.id.btn_history_result})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_help:
                ...
                Dialog dialog_help = DialogUtils.createHelpDialog(TimingModuleActivity.this,list);
