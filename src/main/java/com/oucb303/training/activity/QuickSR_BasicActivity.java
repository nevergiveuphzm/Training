...
public class QuickSR_BasicActivity extends AppCompatActivity {
...
//    private char[] deviceNums;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //填充屏幕的UI
        setContentView(R.layout.activity_quick_sr__basic);
        //返回xml中定义的视图或组件的ID
    ...
    public void onBackPressed() {
        if (trainingFlag) {
            Toast.makeText(QuickSR_BasicActivity.this, "请先停止训练后再退出!", Toast
                    .LENGTH_SHORT).show();
            return;
        }
        super.onBackPressed();
    ...
    public void initView() {
        ...
        totalNum =Device.DEVICE_LIST.size();
        everyLightNum =  1;
        ...
        for (int j = 1; j <= maxGroupNum; j++)
            groupNumChoose[j] = j + " 组";
                ...
                //分组数的下拉框
                spGroupNum.setOnItemSelectedListener(new SpinnerItemSelectedListener(QuickSR_BasicActivity.this, spGroupNum, groupNumChoose) {
                    @Override
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        groupSize = 1;
                        ///初始化分组listView
                        groupListViewAdapter = new GroupListViewAdapter(QuickSR_BasicActivity.this, 1);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_help:
                ...
                Dialog dialog_help = DialogUtils.createHelpDialog(QuickSR_BasicActivity.this,list);
            ...
            case R.id.btn_on:
                //totalNum组数，1：每组设备个
                // +数，0：类型
                device.turnOnButton(groupNum, everyLightNum, 0);
                break;
            case R.id.btn_off:
                device.turnOffAllTheLight();
                break;
            case R.id.img_save_new:
                ...
                break;
            case R.id.img_set:
                CustomDialog dialog = new  CustomDialog(QuickSR_BasicActivity.this,"From btn 2",new CustomDialog.ICustomDialogEventListener() {
                    @Override
                ...
                operateUtils.setScreenWidth(QuickSR_BasicActivity.this,dialog,0.95,0.7);
                break;
        }
    }
