...
public class QuickSR_Upgrade2Activity extends AppCompatActivity {
...
//    private char[] deviceNums;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //填充屏幕的UI
        setContentView(R.layout.activity_quick_sr__upgrade2);
        //返回xml中定义的视图或组件的ID
    ...
    public void onBackPressed() {
        if (trainingFlag) {
            Toast.makeText(QuickSR_Upgrade2Activity.this, "请先停止训练后再退出!", Toast
                    .LENGTH_SHORT).show();
            return;
        }
        super.onBackPressed();
    ...
    public void initView() {
        ...
        spDevNum.setOnItemSelectedListener(new SpinnerItemSelectedListener(this, spDevNum, num) {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //分组数的下拉框
                spGroupNum.setOnItemSelectedListener(new SpinnerItemSelectedListener(QuickSR_Upgrade2Activity.this, spGroupNum, groupNumChoose) {
                    @Override
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        groupNum = i;
                        ...
                        groupSize = totalNum ;
                        ///初始化分组listView
                        groupListViewAdapter = new GroupListViewAdapter(QuickSR_Upgrade2Activity.this,totalNum);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_help:
                ...
                Dialog dialog_help = DialogUtils.createHelpDialog(QuickSR_Upgrade2Activity.this,list);
...
//                stopTraining();
            ...
            case R.id.img_save_new:
                ...
                break;
            case R.id.img_set:
                CustomDialog dialog = new  CustomDialog(QuickSR_Upgrade2Activity.this,"From btn 2",new CustomDialog.ICustomDialogEventListener() {
                    @Override
                ...
                operateUtils.setScreenWidth(QuickSR_Upgrade2Activity.this,dialog,0.95,0.7);
                break;
        }
    }
