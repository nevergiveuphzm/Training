    ...
    public void onClick(View view) {
        ...
        switch (id){
            case R.id.img_action_mode_light:
                c_char[0]='1';
                imgActionModeTouch.setImageResource(R.drawable.btn_uncheckbox); ;
                imgActionModeLight.setImageResource(R.drawable.btn_checkbox); ;
                imgActionModeTogether.setImageResource(R.drawable.btn_uncheckbox);
                break;
            case R.id.img_action_mode_touch:
                c_char[0]='2';
                 imgActionModeTouch.setImageResource(R.drawable.btn_checkbox); ;
                 imgActionModeLight.setImageResource(R.drawable.btn_uncheckbox); ;
                 imgActionModeTogether.setImageResource(R.drawable.btn_uncheckbox);
                break;
            case R.id.img_action_mode_together:
                ...
                imgActionModeTouch.setImageResource(R.drawable.btn_uncheckbox); ;
                imgActionModeLight.setImageResource(R.drawable.btn_uncheckbox); ;
                imgActionModeTogether.setImageResource(R.drawable.btn_checkbox);
                break;
            case R.id.img_light_color_blue:
                c_char[1]='1';
                 imgLightColorBlue.setImageResource(R.drawable.btn_checkbox) ;
                 imgLightColorRed.setImageResource(R.drawable.btn_uncheckbox) ;
                 imgLightColorBlueRed.setImageResource(R.drawable.btn_uncheckbox);
                break;
            case R.id.img_light_color_red:
                c_char[1]='2';
                imgLightColorBlue.setImageResource(R.drawable.btn_uncheckbox) ;
                imgLightColorRed.setImageResource(R.drawable.btn_checkbox) ;
                imgLightColorBlueRed.setImageResource(R.drawable.btn_uncheckbox);
                break;
            case R.id.img_light_color_blue_red:
                ...
                imgLightColorBlue.setImageResource(R.drawable.btn_uncheckbox) ;
                imgLightColorRed.setImageResource(R.drawable.btn_uncheckbox) ;
                imgLightColorBlueRed.setImageResource(R.drawable.btn_checkbox);
                break;
            case R.id.img_blink_mode_none:
                c_char[2]='1';
                imgBlinkModeNone.setImageResource(R.drawable.btn_checkbox) ;
                imgBlinkModeSlow.setImageResource(R.drawable.btn_uncheckbox);
                imgBlinkModeFast.setImageResource(R.drawable.btn_uncheckbox);
                break;
            case R.id.img_blink_mode_slow:
                c_char[2]='2';
                imgBlinkModeNone.setImageResource(R.drawable.btn_uncheckbox) ;
                imgBlinkModeSlow.setImageResource(R.drawable.btn_checkbox);
                imgBlinkModeFast.setImageResource(R.drawable.btn_uncheckbox);
                break;
            case R.id.img_blink_mode_fast:
                ...
                imgBlinkModeNone.setImageResource(R.drawable.btn_uncheckbox) ;
                imgBlinkModeSlow.setImageResource(R.drawable.btn_uncheckbox);
                imgBlinkModeFast.setImageResource(R.drawable.btn_checkbox);
                break;
            case R.id.btn_ok:
